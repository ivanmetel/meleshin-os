 ...
 "projects": [
  {
   ...
   "tasks": [
    { "title": "Уточнить объём подготовки стен в кухне", "author": "Анна Соколова", "created": "2026-09-23", "deadline": "2026-09-25", "assignee": "Анна Соколова", "status": "new" },
    { "title": "Собрать референсы для планировки", "author": "Анна Соколова", "created": "2026-09-16", "deadline": "2026-09-20", "assignee": "Анна Соколова", "status": "done" }
   ],
   "timesheets": [],
   "ops": [],
   "history": []
  },
  {
   ...
   "docs": [
    ...
    { "name": "Бюджет клиента.pdf", "type": "Бюджет клиента", "dir": "out", "party": "Александр Ветров", "date": "2026-06-15", "status": "sent", "version": "v2" },
    { "name": "Исходный внутренний бюджет.pdf", "type": "Внутренний бюджет", "dir": "int", "party": "Анна Соколова", "date": "2026-06-03", "status": "approved", "version": "v1" }
   ],
   "tasks": [
    { "title": "Приёмка штукатурных работ", "author": "Анна Соколова", "created": "2026-06-20", "deadline": "2026-06-24", "assignee": "Сергей Кравцов", "status": "review" },
    { "title": "Заказать плитку для санузла", "author": "Анна Соколова", "created": "2026-06-05", "deadline": "2026-06-12", "assignee": "Анна Соколова", "status": "done" },
    { "title": "Согласовать изменение объёма подготовки стен", "author": "Анна Соколова", "created": "2026-09-20", "deadline": "2026-09-26", "assignee": "Анна Соколова", "status": "working" },
    { "title": "Обновить схему электрики", "author": "Сергей Кравцов", "created": "2026-06-10", "deadline": "2026-07-15", "assignee": "Сергей Кравцов", "status": "working" }
   ],
   "timesheets": [
    { "date": "2026-06-12", "person": "Сергей Кравцов", "work": "Демонтажные работы", "hours": 8, "rate": 15, "status": "approved" },
    { "date": "2026-06-13", "person": "Сергей Кравцов", "work": "Демонтажные работы", "hours": 8, "rate": 15, "status": "approved" },
    { "date": "2026-06-18", "person": "Анна Соколова", "work": "Контроль объекта", "hours": 4, "rate": 22, "status": "approved" },
    { "date": "2026-06-20", "person": "Сергей Кравцов", "work": "Штукатурка стен (приёмка)", "hours": 6, "rate": 15, "status": "draft" },
  ...
  },
  {
   ...
   "tasks": [
    { "title": "Передать гарантийные документы", "author": "Анна Соколова", "created": "2026-07-25", "deadline": "2026-07-30", "assignee": "Дмитрий Гусев", "status": "done" },
    { "title": "Архивировать проект", "author": "Анна Соколова", "created": "2026-08-01", "deadline": "2026-08-05", "assignee": "Анна Соколова", "status": "done" }
   ],
   "timesheets": [
    { "date": "2026-02-14", "person": "Дмитрий Гусев", "work": "Демонтажные работы", "hours": 8, "rate": 15, "status": "approved" },
    { "date": "2026-03-20", "person": "Анна Соколова", "work": "Контроль объекта", "hours": 6, "rate": 22, "status": "approved" },
    { "date": "2026-06-25", "person": "Дмитрий Гусев", "work": "Установка дверей", "hours": 7, "rate": 15, "status": "approved" }
   ],
   "ops": [
